...
## HAL
PRODUCT_COPY_FILES += \\
    vendor/__VENDOR__/__DEVICE__/proprietary/lib/hw/sensors.p350.so:system/lib/hw/sensors.p350.so \\
    vendor/__VENDOR__/__DEVICE__/proprietary/lib/hw/gralloc.p350.so:system/lib/hw/gralloc.p350.so
